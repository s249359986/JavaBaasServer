...
//        $menu.offset({top:10,left:300});


    //  $menu.offset({ top: $menuButton.offset().top + $menuButton.height(), left: $menuButton.offset().left });


      //$menu.offset({ top:-420+ $menuButton.height(), left: $menuButton.offset().left });//临时修改
